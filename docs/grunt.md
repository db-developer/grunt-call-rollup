...
1. git fork [grunt-call-rollup plugin for grunt](https://github.com/db-developer/grunt-call-rollup) (https://github.com/db-developer/grunt-call-rollup.git)
2. cd into forked grunt-call-rollup directory
3. open a shell
...
The code of grunt-call-rollup can be tested. A [mocha](https://mochajs.org/ "Homepage of mocha")/[istanbul](https://istanbul.js.org/ "Homepage of istanbul") testsuite is provided. See directory <code>test</code>.  
Open a shell to run the tests, make sure the environment is set, cd into the forked grunt-call-rollup directory and run: <code>grunt test</code>
